...
static Pentry nextentry (AjPFile libr, AjPFile libs, int ifile);
static AjBool gcgopenlib(AjPStr lname, AjPFile* libr, AjPFile* libs);
static int gcggetent(AjPFile libr, AjPFile libs,
		     int *d_pos, int *s_pos, AjPStr* libstr, AjPList alc);
static int pirgetent(AjPFile libr, AjPFile libs,
		     int *d_pos, int *s_pos, AjPStr* libstr, AjPList alc);
static int gcgappent( AjPFile libr, AjPFile libs,
		     AjPStr* libstr);
...
static int gcggetent(AjPFile libr, AjPFile libs,
		     int *d_pos, int *s_pos, AjPStr* libstr, AjPList acl) {
...
** @param [r] libs [AjPFile] Sequence file
** @param [w] libstr [AjPStr*] ID
** @return [int] Sequence length for this section
** @@
******************************************************************************/

static int gcgappent (AjPFile libr, AjPFile libs, AjPStr* libstr) {
