...
/* is a search string specified */
  if (ajStrLen(search)) {
    ...
    (void) embGrpOutputGroupsList(outfile, newlist, !groups, html, link1, link2);
    (void) embGrpGroupsListDel(&newlist);
  } else if (alphabetic) {      
/* list all programs in alphabetic order */
    (void) embGrpOutputGroupsList(outfile, alpha, !groups, html, link1, link2);
  } else {
/* just show the grouped sets of programs */
    (void) embGrpOutputGroupsList(outfile, glist, !groups, html, link1, link2);
