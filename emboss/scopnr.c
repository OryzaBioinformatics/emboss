...
** Operation
** 
** scopnr parses an embl-like format scop classification file containing 
** domain sequence information generated by the EMBOSS application scopseqs, 
** and writes in the same format a file of non-redundant domains.  The format 
** of these files is explained in the scopparse documentation.  
**
...
**
** scopnr generates a log file an excerpt of which is shown (Figure 1). The 
...
**
**
** Figure 1.  Excerpt from scopnr log file
