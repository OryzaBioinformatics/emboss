...
**
** Removing redundancy from Escop.dat
...
** alignments. Domain sequences are extracted from the clean domain coordinate 
** files generated by the EMBOSS application domainer.  
**
