...
** records (Figure 1 - generated by the EMBOSS applications scopalign) and a 
** file of database hits (Figure 2 - generated by the EMBOSS application 
** psiblasts or swissparse and possibly processed by seqsort), and extends the 
** structure-based alignment with sequences from the hits file one sequence at 
** a time by calling clustalw.  A multiple sequence alignment in clustal format 
