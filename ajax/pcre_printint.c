...
print_internals(pcre *external_re, FILE *f)
{
	...
	case OP_CALLOUT:
	    ...
	    /* OP_XCLASS can only occur in UTF-8 mode. However,
	       there's no harm in having this code always here, and it
	       makes it less messy without all those #ifdefs. */
